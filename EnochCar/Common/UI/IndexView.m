...
- (void)attributeSettings {
    ...
    //字体颜色
    if (!self.titleColor) {
        self.titleColor = [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1.f];
    }
    //右边距
...
- (UIImageView *)selectedImageView {
    if (!_selectedImageView) {
        ...
        _selectedImageView.backgroundColor = [UIColor colorWithRed:252/255.0 green:215/255.0 blue:139/255.0 alpha:1.f];
    }
